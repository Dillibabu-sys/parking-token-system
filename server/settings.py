...
SECRET_KEY = 'django-insecure-%^e-tzitm$=6$+vv)ap&g(i@8ilg+^n()49!1otyo(hfu$i^bp'
...
DEFAULT_FROM_EMAIL = 'noreply@titanxparking.com'
...
# Template settings - make sure you have this
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],
